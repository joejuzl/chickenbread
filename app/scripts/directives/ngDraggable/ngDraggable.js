  ...
  .directive('ngDrag', ['$rootScope', '$parse', function($rootScope, $parse) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        var onDragFinishCallback = $parse(attrs.ngDragFinish) || null;
        ...
        var onDragEnd = function(evt) {
          if (!onDragFinishCallback) return;
          scope.$apply(function() {
            onDragFinishCallback(scope);
          });
        };
        ...
        var moveElement = function(x, y) {
          ...
          var widthOffset = windowWidth - (imageWidth/2);
          var rotation = (x  - widthOffset) / 10;
          element.css({
            left: x,
            top: y,
            position: 'fixed',
